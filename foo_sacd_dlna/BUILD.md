...
A Microsoft indica actualmente para Visual Studio 2022 um mínimo de 4 GB de RAM, processador x64/ARM64 e, para soluções profissionais típicas, 16 GB de RAM recomendados; as instalações típicas necessitam de 20–50 GB livres e a Microsoft recomenda SSD. citeturn661739search0turn661739search2
...
Este workload inclui os componentes essenciais de C++ para Windows, incluindo MSBuild e as ferramentas de build C++. A documentação Microsoft identifica o workload como `Microsoft.VisualStudio.Workload.VCTools`. citeturn661739search3turn661739search7
...
O Windows SDK é instalado normalmente com o workload de desenvolvimento desktop C++. citeturn661739search6
...
Actualmente, a Microsoft documenta suporte para versões 64-bit do Windows 11 e Windows Server suportado pela edição em causa. O Visual Studio 2022 requer .NET Framework 4.8 para funcionar e o instalador utiliza WebView2 quando necessário. citeturn661739search0turn661739search2
...
A página oficial indica explicitamente project files para **Visual Studio 2019/2022**. citeturn661739search5
