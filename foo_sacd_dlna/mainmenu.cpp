...
public:
    enum { toggle, share, preferences, help, total };
    t_uint32 get_command_count() override { return total; }
    GUID get_command(t_uint32 i) override {
        switch (i) {
        case toggle: return guid_toggle; case share: return guid_share; case preferences: return guid_preferences; case help: return guid_help; default: uBugCheck();
        }
    }
